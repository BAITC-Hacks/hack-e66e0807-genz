...
Это признаки совпадения дат и нагрузки, а не доказательство происхождения средств. Объяснения и предложения запросить данные формируются проверяемыми правилами без LLM. Необязательный адаптер AI описан в README; живой ответ провайдера пока не подтверждён.
