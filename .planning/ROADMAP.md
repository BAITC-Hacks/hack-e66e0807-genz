...
- [x] **Phase 1: Полный локальный MVP** - От трёх parquet до объяснимых ролей, сообществ, приоритетов, интерфейса и воспроизводимого демо. (completed 2026-09-23)
...
- [ ] 02-01-PLAN.md — Временная аналитика, профиль входящих и следующие запросы данных (wave1).
- [ ] 02-02-PLAN.md — Параллельный shadcn UI: временная карточка, Select-фильтры и обзор кластеров (wave1).
- [ ] 02-03-PLAN.md — Независимая проверка реальных расчётов, браузерный сценарий и документация (wave2).
...
**Execution Order:** Phase 1 → Phase 2 → Phase 3. Улучшения не задерживают сдаваемый MVP.

| Phase | Plans Complete | Status | Completed |
|-------|----------------|--------|-----------|
| 1. Полный локальный MVP | 3/3 | Complete    | 2026-09-23 |
| 2. Временные паттерны и углублённая проверка | 0/3 | Executing wave1 | - |
...
- [ ] 03-01-PLAN.md — Astra: дизайн-контракт и новый интерфейс, граф и компонентные проверки.
- [ ] 03-02-PLAN.md — Независимая приёмка, регрессия кейса, документация и доставка.
