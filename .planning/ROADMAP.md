...
- [ ] 01-02-PLAN.md — Параллельный React/Vite shadcn UI: поиск, направленный граф, карточки и скачивание (wave 1).
- [ ] 01-03-PLAN.md — Локальный запуск, интеграционные проверки, README, диаграмма и демо (wave 2).
**UI hint**: yes
