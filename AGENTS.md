...
- Входные parquet включены в корневой data/; run.py, CLI, валидаторы и реальные тесты используют data/ по умолчанию. Исходные файлы организаторов сохранять без изменений. Ожидаемые 2248 узлов / 3119 рёбер / 4840 транзакций — проверяемые свойства этой выгрузки, не зашитые ответы.
